...
public class ActionCardFactory {
  ...
  public static ActionCard[] initCommunityChestCards(Game game, EventReceiver eventReceiver) {
    return new ActionCard[] {
        ...
        new ActionCard("You are assessed for street repair. $40 per house. $115 per hotel.", game) {
          public void performAction(Player player) {
            ...
            eventReceiver.addEvent(String.format("The repairs set you back $%d.", costs));
          }
        },
  ...
  public static ActionCard[] initChanceCards(Game game, EventReceiver eventReceiver) {
    return new ActionCard[] {
        ...
        new ActionCard("Make general repairs on all your property. For each house pay $25. For each hotel pay $100.",
            game) {
          public void performAction(Player player) {
            GameBoard gameBoard = game.getGameBoard();
